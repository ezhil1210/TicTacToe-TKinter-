...
ghdhhd = Label(win, text=(x, "-", o), bg="#373737", fg="light blue", font=('Helvetica', 18, 'bold'))
ghdhhd.grid(row=3, column=1, pady=20)


def reset():
    global b1, b2, b3, b4, b5, b6, b7, b7, b8, b8, b9
    ...
    Radiobutton(win, text="PLAYER vs PLAYER     ", bg="#373737", fg="red", font=('Helvetica', 10, 'bold'), variable=r,
                value=1).grid(row=0, column=4)
    Radiobutton(win, text="PLAYER vs COMPUTER", bg="#373737", fg="red", font=('Helvetica', 10, 'bold'), variable=r,
